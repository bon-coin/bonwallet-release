...
<main>
    ...
    <div class="notify">
        <h4 class="notify_header"><i class="fas fa-exclamation-circle"></i> Separate Wallet</h4>
    ...
    <div class="btn download_btn" @click="download_file">
        I read and understood tips. Start download!
    </div>
</main>
</template>
...
export default {
    methods:{
        download_file(){
            const os = this.$route.hash.slice(1);
            let download_link;
            switch(os){
                case "windows": 
